...
from config import VEHICLE_DETECTION_MODEL, PLATE_DETECTION_MODEL, TEXT_RECOGNITION_MODEL, VOCABULARY
...
text_recognition_model.load_state_dict(torch.load(TEXT_RECOGNITION_MODEL, map_location=torch.device('cpu')))